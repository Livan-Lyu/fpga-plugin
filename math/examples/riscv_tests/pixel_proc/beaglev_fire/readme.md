...
```bash
python build-bitstream.py ../../../math/examples/riscv_tests/pixel_proc/beaglev_fire/pixel_proc.yaml
```

The generated RISC-V test binary is:

```bash
../../../math/examples/riscv_tests/pixel_proc/beaglev_fire/hls_output/pixel_proc.accel.elf
```
